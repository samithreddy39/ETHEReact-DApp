...
-Utilizes Truffle-powered testrpc (also known as Ganache) for local development.
-Web3 serves as the bridge between Ethereum and ReactJS.

# Setup
-Install NodeJS: Download and install the latest version of NodeJS.
-Install Truffle: Install truffle globally using the command npm install -g truffle.
-Install Ethereum RPC: Install Ethereum RPC globally using the command npm install -g ethereumjs-testrpc.
-Clone the Repository: Clone the repository using the command git clone https://github.com/yourusername/ETHEReact-DApp.git.
-Navigate to the Project Directory: Change to the project directory using cd ETHEReact-DApp.
